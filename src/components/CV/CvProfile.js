  ...
  render() {
    ...
    return (
      <article className="cv-profile-article">
        ...
        { github ? <div className="profile-card"><i className="fab fa-github-square"></i>{github}</div>: null }
        { medium ? <div className="profile-card"><i className="fab fa-medium"></i>{medium}</div>: null }
        { linkedin ? <div className="profile-card"><i className="fab fa-linkedin"></i>{linkedin}</div>: null }
      </article>
    )
  }
}
